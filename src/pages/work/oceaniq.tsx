...
// --- Assets ---
import oceanhero from '../../assets/Projects/covers/oceaniqcover.png';

const OceanIqUI: React.FC = () => {
    ...
    const features = [
        {
            ...
            desc: "Engaging quiz flow with instant feedback, helping users learn while actively participating instead of passively reading."
        },
        {
            title: "Progress Tracking & Achievement System",
            desc: "Tracks user performance and completion levels, motivating continued learning through visible progress and milestones."
        },
        {
            title: "Calming Ocean-Inspired Visual Design",
            desc: "Uses a consistent color palette, smooth visuals, and minimal UI to create a relaxing and focused learning environment."
        },
        {
            title: "Intuitive Navigation & Clean Layout",
            desc: "Simple and well-structured interface that makes it easy for users to explore topics, start quizzes, and track progress."
        }
    ];
    ...
    return (
        <div className="min-h-screen bg-black text-white pt-12 pb-24 px-6 sm:px-12 md:px-24">
            ...
            <div className="max-w-7xl mx-auto mb-12 flex justify-between items-center">
                ...
                <span className="text-gray-500 font-mono text-sm uppercase tracking-widest">UI/UX / 2025</span>
            </div>
            ...
            <div className="max-w-7xl mx-auto mb-16">
                ...
                <p className="text-xl md:text-2xl text-gray-400 max-w-3xl leading-relaxed">
                    Learn the ocean, one quiz at a time.
                </p>
            </div>
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 mb-32 border-t border-white/10 pt-12">
                ...
                <div>
                    ...
                    <p className="text-gray-400 text-lg">Balancing engagement and learning in a quiz-based app while keeping the interface simple, avoiding information overload, and maintaining a visually calming experience.</p>
                </div>
                <div>
                    <h4 className="text-gray-500 uppercase text-sm tracking-widest mb-4 font-mono">Outcome</h4>
                    <p className="text-gray-400 text-lg">Delivered a clean, engaging quiz experience with improved usability and better user engagement through structured learning and clear navigation.</p>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto mb-16 flex flex-col lg:flex-row gap-12 items-center justify-between py-20 border-y border-white/10">
                ...
                <div className="flex flex-col sm:flex-row gap-6 md:gap-8 items-center justify-center">
                    {/* FIGMA BUTTON */}
                    <BorderGlow borderRadius={20} glowColor="34 197 94" colors={['#8df6d7', '#05fadd', '#a1faf2']} glowIntensity={0.5}>
                        <a
                            href="https://www.figma.com/community/file/1623616404442773083/oceaniq"
                            target="_blank"
                    ...
                    <BorderGlow borderRadius={20} glowColor="34 197 94" colors={['#22c55e', '#10b981', '#3b82f6']} glowIntensity={0.5}>
                        <a
                            href="https://www.behance.net/gallery/241159447/OceanIQ-UIUX"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group relative z-50 flex items-center justify-center gap-4 bg-black px-10 py-5 rounded-[18px] border border-white/10 hover:bg-neutral-900 transition-all duration-300 min-w-[240px] h-[72px]"
                        >
            ...
            <div className="max-w-7xl mx-auto mb-32">
                ...
                <div className="w-full aspect-video bg-white/5 rounded-[40px] border border-white/10 overflow-hidden shadow-2xl">
                    <iframe
                        ...
                        width="100%"
                        height="100%"
                        src="https://embed.figma.com/proto/ndRUkzbxXwrhyHUjzRsv3T/OceanIQ?node-id=1-5&viewport=473%2C194%2C0.23&scaling=scale-down&content-scaling=fixed&starting-point-node-id=37%3A76&page-id=0%3A1&embed-host=share"
                        allowFullScreen
                        loading="lazy"
                    />
                </div>
